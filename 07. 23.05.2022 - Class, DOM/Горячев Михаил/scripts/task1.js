...
(function Task1() {
    ...
    // вывод заголовка
    document.write(
        '<h2 id="headerArray" class="text-align-center">Исходная коллекция фигур</h2><div id="containerId" class="container">'
    );

    // вывод элементов
    document.write(moduleTask1.figures.reduce((acc, item) => (acc += item.showToString()), ''));
    document.write('</div>');
})();
